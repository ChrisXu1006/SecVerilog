...
`ifndef VC_NET_MSGPACK_V
`define VC_NET_MSGPACK_V
...
(
  ...
  input [`VC_NET_MSG_DEST_NBITS(p,o,s)-1:0]    {L}	dest,
  input [`VC_NET_MSG_SRC_NBITS(p,o,s)-1:0]     {L}	src,
  input [`VC_NET_MSG_OPAQUE_NBITS(p,o,s)-1:0]  {L}	opaque,
  input [`VC_NET_MSG_PAYLOAD_NBITS(p,o,s)-1:0] {L}	payload,

  // Output msg

  output [`VC_NET_MSG_NBITS(p,o,s)-1:0]        {L}	msg
);
