...
ArrayIndexType::ArrayIndexType(perm_string name, perm_string array, expr index)
{
	 name_  = name;
	 array_ = array;
	 index_ = index;
...
ArrayIndexType& ArrayIndexType::operator= (const ArrayIndexType& t)
{
	ArrayIndexType* ret = new ArrayIndexType(t.name_, t.array_, t.index_);
	return *ret;
}

void ArrayIndexType::set_type(const perm_string name, perm_string expr, expr index)
{
	name_  = name;
	array_ = array;
	index_ = index;
...
perm_string ArrayIndexType::get_name() const
{
	return name_;
}

perm_string ArrayIndexType::get_array() const
{
	return array_;
}

expr ArrayIndexType::get_index() const
{
	return index_;
}

bool ArrayIndexType::equals(SecType* st)
{
	ArrayIndexType* it = dynamic_cast<ArrayIndexType*>(st);
	if ( it!=NULL )
		return name_ == it->name_ && expr_ == it->expr_ && index_ == it->index_;
	return false;
}
