...
(
  ...
  input  [`VC_NET_MSG_NBITS(p,o,s)-1:0] {Control domain} msg,

  // Output message

  output [`VC_NET_MSG_DEST_NBITS(p,o,s)-1:0]    {Control domain} dest,
  output [`VC_NET_MSG_SRC_NBITS(p,o,s)-1:0]     {Control domain} src,
  output [`VC_NET_MSG_OPAQUE_NBITS(p,o,s)-1:0]  {Control domain} opaque,
  output [`VC_NET_MSG_PAYLOAD_NBITS(p,o,s)-1:0] {Control domain} payload
);
